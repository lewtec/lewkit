// Package wazero registers the wazero tree-sitter engine.
//
// This package imports the wazero grammar runtime only.
...
func (factory) ID() string                               { return "treesitter_wazero" }
