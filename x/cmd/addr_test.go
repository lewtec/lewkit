...
func TestAddrArg(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "host port", in: "127.0.0.1:8080", want: "127.0.0.1:8080"},
		{name: "all interfaces", in: ":8080", want: ":8080"},
		{name: "bare port", in: "8080", want: ":8080"},
		{name: "ipv6", in: "[::1]:443", want: "[::1]:443"},
		{name: "hostname", in: "localhost:80", want: "localhost:80"},
