...
func newTerraform() (tool.Tool, error) {
...
func (t *terraformTool) Pin() tool.Pin {
	var pin tool.Pin
	pin.Name = "hashicorp/terraform"
	pin.Datasource = "github-releases"
	pin.Versioning = "semver"

	return pin
}

func (t *terraformTool) ListArtifacts(ctx context.Context, version string) ([]tool.Artifact, error) {
...
func (t *terraformTool) InstallArtifact(ctx context.Context, artifact tool.Artifact, destDir string) error {
...
func (t *terraformTool) InstallChecks() []tool.Check {
	return tool.Checks(tool.Binary("terraform"))
}
